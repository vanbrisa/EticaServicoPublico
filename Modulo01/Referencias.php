        ...
        <div id="main">
            ...
            <div class="main-content container-fluid">
                    ...
                    <div class="col-md-10"> <!-- Begin col-md-10 -->
                        <div class="page-title">
                            ...
                            <div class="bd-callout bd-callout-success">
                                ...
                                <p class="Texto"> UNIVERSIDADE FEDERAL DE SANTA CATARINA. Manual de identidade visual. Disponível em: <a href="http://www.identidade.ufsc.br" target="_blank">http://www.identidade.ufsc.br</a>. Acesso em: 08 ago. 2022.</p>
                ...
                <div class="text-center">
                    ...
                    <a href="http://cursos.egp.ce.gov.br/mod/quiz/view.php?id=730" class="btn btn-primary" role="button" aria-pressed="true"><i class="fa fa-tasks"></i> Realização Avaliação 01 </a>
                </div>
